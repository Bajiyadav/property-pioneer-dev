  ...
  const PHASES = [
    {
      ...
      status: "LIVE NOW",
      date: "Q1 2026",
      desc: "Flagship launch in Madhapur, Gachibowli, Kondapur, Hitech City & Financial District.",
      live: true,
    },
    {
      phase: "Phase 2",
      ...
      status: "Coming Soon",
      date: "Q3 2026",
      desc: "Expanding to Koramangala, Whitefield, Indiranagar, HSR Layout & Electronic City.",
      live: false,
    },
    {
      phase: "Phase 3",
      ...
      status: "Coming Soon",
      date: "Q4 2026",
      desc: "Covering OMR IT Corridor, Velachery, Anna Nagar & Adyar.",
      live: false,
    },
    {
      phase: "Phase 4",
      ...
      status: "Coming Soon",
      date: "Q4 2026",
      desc: "Covering BKC, Bandra, Powai, Thane & Navi Mumbai tech hubs.",
      live: false,
    },
    {
      phase: "Phase 5",
      ...
      status: "Coming Soon",
      date: "Q1 2027",
      desc: "Covering Gurugram Golf Course Rd, Cyber City, Noida & Saket.",
      live: false,
    },
  ];
    ...
    <section id="roadmap" className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
      <div className="text-center">
        ...
        <p className="mt-1 text-xs sm:text-sm text-muted-foreground max-w-xl mx-auto">
          Urban Properties is launching first in Hyderabad, with direct owner verification pipelines
          expanding across India's top real estate markets.
        </p>
      </div>
        ...
        {PHASES.map((item, idx) => (
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <span
                className={`rounded-full px-2.5 py-0.5 text-[10px] font-extrabold ${
                  item.live ? "bg-emerald-600 text-white" : "bg-secondary text-muted-foreground"
                }`}
              >
                {item.status}
              </span>
            ...
            <h3 className="mt-3 text-base font-extrabold text-foreground flex items-center gap-1.5">
              <MapPin
                className={`h-4 w-4 ${item.live ? "text-emerald-500" : "text-muted-foreground"}`}
              />
              {item.city}
            </h3>
