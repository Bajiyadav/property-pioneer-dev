...
const UPCOMING = [
  {
    ...
    desc: "Verified flats, independent houses, and villas for purchase across India.",
    icon: Home,
  },
  {
    title: "Commercial Spaces",
    category: "Office & Retail",
    desc: "Office spaces, IT parks, retail shops, and commercial land listings.",
    icon: Building2,
  },
  {
    title: "Plots & Land",
    category: "Open Land",
    desc: "HMDA & DTCP approved residential and commercial plots.",
    icon: Compass,
  },
  {
    title: "Farm Land",
    category: "Agricultural",
    desc: "Managed farm lands, agricultural acres, and resort plots.",
    icon: Trees,
  },
  {
    title: "Villa Sales",
    category: "Luxury Homes",
    desc: "Gated community luxury villas with private gardens and swimming pools.",
    icon: Castle,
  },
  {
    title: "Home Loans",
    category: "Financing",
    desc: "Pre-approved home loans from top partner banks at lowest interest rates.",
    icon: Landmark,
  },
  {
    title: "Mobile Apps",
    category: "iOS & Android",
    desc: "Native mobile app with push alerts, offline maps, and 1-tap WhatsApp.",
    icon: Smartphone,
  },
];
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="text-center max-w-2xl mx-auto mb-10">
          ...
          <h2 className="mt-3 text-2xl font-semibold text-foreground sm:text-3xl">
            Coming Soon to Urban Properties
          </h2>
          <p className="mt-2 text-sm text-muted-foreground">
            We are actively building the complete real estate & home services ecosystem.
          </p>
        </div>
