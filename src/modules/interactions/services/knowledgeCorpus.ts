...
export const SEEDHA_KNOWLEDGE_DOCS: KnowledgeChunk[] = [
  ...
  },
  {
    ...
    category: "guide",
    title: "Rental Agreement Drafting & Management",
    content:
      "Seedha Properties provides a clean, 4-step guided rental agreement creation service (/rental-agreement and /rental-agreement/create). Features include: 1. Guided party & property details capture, 2. Customizable tenancy terms & standard legal clauses, 3. Summary review and verification, 4. Instant document preview, download as PDF, and direct browser printing. Users can save drafts, manage active agreements from their 'My Agreements' dashboard (/my-agreements), and print deeds for local stamping.",
    tags: [
      "agreement",
      "rental agreement",
      "rent agreement",
