...
> = {
  ...
  slow_network: {
    ...
    description: "Your network connection seems slow. We're still retrieving your data.",
  ...
  no_search_results: {
    ...
    description: "We couldn't find properties matching your criteria. Try adjusting your filters.",
    iconBg: "bg-muted text-muted-foreground",
    iconColor: "text-muted-foreground",
    ariaRole: "status",
  },
  ...
  session_expired: {
    ...
    description: "Your authentication session has ended. Please sign in again to continue.",
  ...
  payment_pending: {
    ...
    description: "Waiting for payment gateway confirmation. Please don't close this window.",
    iconBg: "bg-primary/10 text-primary",
