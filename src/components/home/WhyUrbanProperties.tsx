    ...
    <section className="bg-secondary/40 py-12 sm:py-16">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="text-center max-w-2xl mx-auto mb-10">
          <p className="text-xs font-semibold uppercase tracking-wide text-primary">Why Urban Properties</p>
          <h2 className="mt-1 text-2xl font-semibold text-foreground sm:text-3xl">The Smartest Way to Rent & Buy</h2>
          <p className="mt-2 text-sm text-muted-foreground">Built specifically for the needs of Indian renters, buyers, and property owners.</p>
        </div>
