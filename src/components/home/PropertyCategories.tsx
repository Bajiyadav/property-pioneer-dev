...
const CATEGORIES = [
  { id: "rent", title: "Rent", icon: Key, count: "4,500+ Homes", startPrice: "₹4,000/mo", path: "/properties" },
  { id: "buy", title: "Buy", icon: Home, count: "2,800+ Properties", startPrice: "₹15 Lakhs", path: "/buy" },
  { id: "commercial", title: "Commercial", icon: Building2, count: "850+ Spaces", startPrice: "₹12,000/mo", path: "/commercial" },
  { id: "apartments", title: "Apartments", icon: Building, count: "3,200+ Units", startPrice: "₹8,000/mo", path: "/properties" },
  { id: "villas", title: "Villas & Houses", icon: Castle, count: "650+ Homes", startPrice: "₹25,000/mo", path: "/villas" },
  { id: "pg-hostel", title: "PG & Hostels", icon: BedDouble, count: "1,400+ Beds", startPrice: "₹3,500/mo", path: "/pg-hostels" },
  { id: "plots", title: "Plots & Land", icon: Compass, count: "920+ Plots", startPrice: "₹8 Lakhs", path: "/plots" },
  { id: "farmlands", title: "Farm Lands", icon: Trees, count: "310+ Acres", startPrice: "₹12 Lakhs", path: "/farm-lands" },
];
