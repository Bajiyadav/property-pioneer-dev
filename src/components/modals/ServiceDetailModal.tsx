      ...
      <DialogContent className="sm:max-w-xl bg-card border-border p-6 rounded-3xl shadow-2xl">
        <DialogHeader>
          <div className="flex items-center justify-between">
            <span className={`rounded-full px-3 py-1 text-xs font-bold uppercase tracking-wider ${
              data.status.includes("Live") ? "bg-emerald-600/10 text-emerald-600 dark:text-emerald-400" : "bg-primary/10 text-primary"
            }`}>
              {data.status}
            </span>
        ...
        <div className="mt-4 space-y-5">
          ...
          <div className="rounded-2xl border border-border bg-secondary/30 p-4">
            <h4 className="text-xs font-semibold uppercase tracking-wide text-foreground mb-3">What's Included</h4>
            <div className="grid grid-cols-2 gap-2 text-xs text-foreground">
              <span className="flex items-center gap-1.5"><CheckCircle2 className="h-4 w-4 text-emerald-500" /> Verified Technicians</span>
              <span className="flex items-center gap-1.5"><CheckCircle2 className="h-4 w-4 text-emerald-500" /> Damage Guarantee</span>
              <span className="flex items-center gap-1.5"><CheckCircle2 className="h-4 w-4 text-emerald-500" /> Transparent Pricing</span>
              <span className="flex items-center gap-1.5"><CheckCircle2 className="h-4 w-4 text-emerald-500" /> Same-Day Slot Available</span>
            </div>
          </div>
          ...
          {booked ? (
            ...
            <form onSubmit={handleBooking} className="space-y-3">
              <p className="text-xs font-semibold text-foreground">Request Free Quote / Instant Booking Callback</p>
