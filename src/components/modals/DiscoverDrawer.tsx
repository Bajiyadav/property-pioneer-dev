        ...
        <div className="mt-6 space-y-8">
          ...
          <div className="rounded-2xl border border-border bg-secondary/30 p-5">
            ...
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
              ...
              >
                <Train className="h-4 w-4 text-primary" /> Near Metro Stations
              </Link>
              <Link
                to="/properties"
                ...
                className="flex items-center gap-2 rounded-xl bg-card p-3 text-xs font-semibold text-foreground border border-border/60 hover:border-primary"
              >
                <Briefcase className="h-4 w-4 text-primary" /> Near IT Parks
              </Link>
              <Link
                to="/properties"
                ...
                className="flex items-center gap-2 rounded-xl bg-card p-3 text-xs font-semibold text-foreground border border-border/60 hover:border-primary"
              >
                <GraduationCap className="h-4 w-4 text-primary" /> Near Colleges
              </Link>
              <Link
                to="/properties"
                ...
                className="flex items-center gap-2 rounded-xl bg-card p-3 text-xs font-semibold text-foreground border border-border/60 hover:border-primary"
              >
                <Stethoscope className="h-4 w-4 text-primary" /> Near Hospitals
              </Link>
            </div>
          </div>
