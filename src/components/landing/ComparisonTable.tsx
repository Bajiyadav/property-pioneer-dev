  ...
  const MATRIX = [
    {
      ...
      urban: "0% Zero Commission",
      broker: "2% to 3% Heavy Fee",
      legacy: "Hidden Charges",
    },
    {
      feature: "Seller Verification",
      urban: "Mandatory Aadhaar/PAN ID",
      broker: "Unverified Brokers",
      legacy: "Frequent Fake Leads",
    },
    {
      feature: "Legal Title Verification",
      urban: "100% Pre-Audited Deeds",
      broker: "Manual & Risky",
      legacy: "Self-Reported Only",
    },
    {
      feature: "AI Valuation & Trends",
      urban: "Real-Time Machine Learning",
      broker: "Inflated Quotes",
      legacy: "Outdated Data",
    },
    {
      feature: "Direct Owner Contact",
      urban: "Instant Direct Connect",
      broker: "Blocked by Middleman",
      legacy: "Paid Contact Limits",
    },
    {
      feature: "Digital E-Stamp Agreements",
      urban: "Included Instantly",
      broker: "Manual Paperwork",
      legacy: "Third-Party Extra Fee",
    },
    {
      feature: "Bank Loan Assistance",
      urban: "Direct Bank Integrations",
      broker: "High Agent Margins",
      legacy: "Lead Selling to Banks",
    },
  ];
    ...
    <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
      <div className="text-center">
        ...
        <p className="mt-1 text-xs sm:text-sm text-muted-foreground max-w-xl mx-auto">
          See how our tech-first platform compares against traditional brokers and legacy property
          sites.
        </p>
      </div>
        ...
        <table className="w-full text-left text-xs">
          <thead>
            <tr className="border-b border-border/60 bg-secondary/50">
              ...
              <th className="p-4 font-extrabold text-emerald-600 dark:text-emerald-400 bg-emerald-600/10">
                Urban Properties
              </th>
