  ...
  return (
    <section className="mx-auto max-w-4xl px-4 py-16 sm:px-6">
      <div className="text-center mb-10">
        ...
        <h2 className="mt-3 text-2xl font-bold text-foreground sm:text-3xl">Everything You Need to Know</h2>
      </div>
      ...
      <div className="space-y-3">
        {faqs.map((faq, idx) => {
          ...
          return (
            <div key={idx} className="rounded-2xl border border-border/50 bg-card overflow-hidden transition">
              <button
