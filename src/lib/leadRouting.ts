...
export async function logLiveActivity(input: LiveActivityInput) {
  try {
    ...
    const { error } = await (supabase.from as any)("live_activities").insert({
      user_id: userId,
...
export async function scheduleCustomerVisit(input: VisitScheduleInput) {
  ...
  const { data, error } = await (supabase.from as any)("visit_schedules")
    .insert({
      ...
      locality: input.locality || "Hyderabad",
...
export async function fetchLiveActivities(localityFilter?: string) {
  let query = (supabase.from as any)("live_activities")
...
export async function fetchVisitSchedules(localityFilter?: string) {
  let query = (supabase.from as any)("visit_schedules")
