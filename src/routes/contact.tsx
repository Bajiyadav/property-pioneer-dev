      ...
      <section className="pt-10 pb-8 border-b border-border/40 bg-gradient-to-b from-primary/5 via-background to-background">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 text-center space-y-3">
          ...
          <h1 className="text-3xl sm:text-4xl font-black text-foreground">
            Contact {APP_NAME} Support &amp; Agents
          </h1>
          <p className="text-xs sm:text-sm text-muted-foreground max-w-lg mx-auto">
            Have questions about a property listing, site visit, or zero brokerage services? Reach
            out to our Hyderabad HQ or local area specialists.
          </p>
        </div>
      </section>
            ...
            <div className="rounded-3xl border border-border/80 bg-card p-6 sm:p-8 space-y-6 shadow-sm">
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Fill in your requirements and our local territory agent in your area will contact
                  you.
                </p>
              </div>
              ...
              {submitted ? (
                <div className="py-12 text-center space-y-4">
                  ...
                  <p className="text-xs text-muted-foreground max-w-md mx-auto">
                    Thank you, <strong className="text-foreground">{name}</strong>. Our Area Agent
                    for <strong className="text-foreground">{locality}</strong> will call you
                    shortly at <strong className="text-foreground">{phone}</strong>.
                  </p>
                  <button
                    onClick={() => {
                      setSubmitted(false);
                ...
                <form onSubmit={handleSubmit} className="space-y-4 text-xs">
                  ...
                  <div className="space-y-1">
                    <label className="font-bold text-foreground">
                      Your Message or Property Inquiry *
                    </label>
                    <textarea
                      required
                      value={message}
      ...
      <section className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="rounded-3xl border border-border/80 bg-card p-4 space-y-3 shadow-sm overflow-hidden">
          <h3 className="font-bold text-foreground text-xs flex items-center gap-1.5">
            <MapPin className="h-4 w-4 text-emerald-500" /> Hitec City, Hyderabad Office Map
            Location
          </h3>
