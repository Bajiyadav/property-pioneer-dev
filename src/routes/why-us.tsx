...
export const Route = createFileRoute("/why-us")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: `Discover why thousands of tenants and property owners in Hyderabad trust ${APP_NAME} for 0% brokerage, 100% verified listings, and local area agent support.`,
      },
    ],
  }),
});
    ...
    <div className="min-h-screen bg-background pb-16 space-y-16">
      ...
      <section className="relative overflow-hidden pt-12 pb-16 border-b border-border/40 bg-gradient-to-b from-primary/5 via-background to-background">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 text-center space-y-6">
          ...
          <h1 className="text-3xl sm:text-5xl font-black text-foreground tracking-tight max-w-3xl mx-auto leading-tight">
            Rent &amp; Buy Properties with <span className="text-primary">Zero Brokerage</span> &amp; Total Trust
          </h1>

          <p className="text-muted-foreground text-sm sm:text-base max-w-2xl mx-auto leading-relaxed">
            {APP_NAME} connects tenants directly with verified property owners and local area specialists, eliminating middleman fees and ensuring transparent deals across Hyderabad.
          </p>
      ...
      <section className="mx-auto max-w-6xl px-4 sm:px-6 space-y-12">
        <div className="text-center space-y-2">
          <h2 className="text-2xl sm:text-3xl font-black text-foreground">Why 50,000+ Users Trust {APP_NAME}</h2>
          <p className="text-muted-foreground text-xs sm:text-sm">Built to eliminate real estate scams and high brokerage fees</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="rounded-3xl border border-border/80 bg-card p-6 space-y-4 shadow-sm hover:border-primary/40 transition">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">
              Never pay 1 to 2 months' rent as broker commission again. Contact owners directly or get free walkthrough assistance from our assigned area agents.
            </p>
          </div>
          ...
          <div className="rounded-3xl border border-border/80 bg-card p-6 space-y-4 shadow-sm hover:border-primary/40 transition">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">
              Every home listed on our portal undergo physical verification checks for photos, ownership records, and amenities accuracy. No fake or outdated photos.
            </p>
          </div>
          ...
          <div className="rounded-3xl border border-border/80 bg-card p-6 space-y-4 shadow-sm hover:border-primary/40 transition">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">
              Our micro-market area agents in Kukatpally, Gachibowli, Madhapur, and Kondapur accompany you on site visits and assist with rental agreements.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-5xl px-4 sm:px-6">
        <div className="rounded-3xl border border-border/80 bg-card p-6 sm:p-8 space-y-6 shadow-md">
          <div className="text-center space-y-1">
            <h3 className="text-xl font-extrabold text-foreground">Traditional Agents vs. {APP_NAME}</h3>
            <p className="text-xs text-muted-foreground">See how much time and money you save with us</p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
            <div className="p-4 rounded-2xl bg-rose-500/5 border border-rose-500/20 space-y-3">
              <h4 className="font-bold text-rose-600 dark:text-rose-400 text-sm">Traditional Real Estate Brokers</h4>
              <ul className="space-y-2 text-muted-foreground">
                <li className="flex items-start gap-2">❌ 1 to 2 months' rent brokerage charged</li>
                <li className="flex items-start gap-2">❌ Unverified photos &amp; misleading prices</li>
            ...
            <div className="p-4 rounded-2xl bg-emerald-500/5 border border-emerald-500/20 space-y-3">
              <h4 className="font-bold text-emerald-600 dark:text-emerald-400 text-sm">{APP_NAME} Platform</h4>
              <ul className="space-y-2 text-foreground font-medium">
                <li className="flex items-start gap-2"><CheckCircle2 className="h-4 w-4 text-emerald-500 shrink-0" /> ₹0 Brokerage for Tenants &amp; Buyers</li>
                <li className="flex items-start gap-2"><CheckCircle2 className="h-4 w-4 text-emerald-500 shrink-0" /> Physically Verified Photos &amp; Video Tours</li>
                <li className="flex items-start gap-2"><CheckCircle2 className="h-4 w-4 text-emerald-500 shrink-0" /> Free Area Agent Site Visit Assistance</li>
                <li className="flex items-start gap-2"><CheckCircle2 className="h-4 w-4 text-emerald-500 shrink-0" /> Online E-Stamping &amp; Rental Agreements</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="rounded-3xl bg-gradient-to-r from-emerald-600 to-teal-700 p-8 text-white text-center space-y-4 shadow-xl">
          ...
          <p className="text-xs sm:text-sm text-emerald-100 max-w-xl mx-auto">
            Browse verified listings in Kukatpally, Gachibowli, Madhapur, Hitec City, and Jubilee Hills with zero brokerage.
          </p>
          <div className="pt-2">
            <Link
              to="/properties"
