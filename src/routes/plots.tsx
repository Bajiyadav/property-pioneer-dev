  ...
  head: () => {
    ...
    return {
      meta: [
        ...
        { name: "description", content: "Buy HMDA, DTCP, and RERA approved residential plot land in Hyderabad, Shankarpally, Mokila, Shadnagar, & ORR growth corridors with 100% legal title clearance." },
        { property: "og:title", content: `HMDA & DTCP Approved Plots — ${APP_NAME}` },
        { property: "og:description", content: "Buy verified residential plots in Hyderabad growth corridors with 0% brokerage." },
...
const PLOTS_FAQS = [
  { q: "Are all listed plots HMDA / DTCP approved?", a: "Yes! Every plot listing undergoes strict layout verification for HMDA, DTCP, or RERA approval with clear LP numbers." },
  { q: "Which growth corridors in Hyderabad are featured?", a: "We feature plots in Mokila, Shankarpally, Tellapur, Patancheru, Shadnagar, Srisailam Highway, and Regional Ring Road (RRR) corridors." },
  { q: "Can I get bank plot loans?", a: "Yes, our partner banks (SBI, HDFC, ICICI) provide up to 70% plot purchase and construction loan clearance." },
  { q: "How are boundary markers verified?", a: "Every layout undergoes digital GPS boundary survey verification before listing." },
];
