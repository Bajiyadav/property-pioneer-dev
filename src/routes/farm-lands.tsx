  ...
  head: () => {
    ...
    return {
      meta: [
        ...
        { name: "description", content: "Invest in clear-title agricultural land, organic managed farmland, and Weekend Farmhouses around Hyderabad, Vikarabad, & Chevella." },
        { property: "og:title", content: `Agricultural & Managed Farm Lands — ${APP_NAME}` },
        { property: "og:description", content: "Invest in verified managed farmlands around Hyderabad with 100% Dharani passbook verification." },
...
const FARMLANDS_FAQS = [
  { q: "How is agricultural land title verified in Telangana?", a: "Every farmland listing undergoes 100% Dharani portal verification, Pahani record checks, and survey number boundary audits." },
  { q: "What is managed organic farming?", a: "Managed farmland includes professional plantation maintenance (sandalwood, mahogany, fruit orchards) with 24/7 caretaker security." },
  { q: "Can non-agriculturalists buy farmlands?", a: "Yes, our legal team assists with state-specific land purchase compliance and Dharani passbook issuance." },
];
