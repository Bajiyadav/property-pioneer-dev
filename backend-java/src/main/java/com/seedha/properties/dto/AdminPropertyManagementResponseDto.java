...
public class AdminPropertyManagementResponseDto {
    ...
    private List<InternalNoteResponseDto> internalNotes = new ArrayList<>();

    public AdminPropertyManagementResponseDto() {}
    ...
    public List<InternalNoteResponseDto> getInternalNotes() { return internalNotes; }
    public void setInternalNotes(List<InternalNoteResponseDto> internalNotes) { this.internalNotes = internalNotes; }
}
